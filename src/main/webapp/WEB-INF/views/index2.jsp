	...
	<div class="desktop-view">
				...
				<div class="columnleftTotalData" id="div2">
					...
					<table id="myTable" style="margin-top: 15px;">
						...
						<tr class="hovertr">
							...
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseReqestData.get(0).token1Req)}</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseResponseData.get(0).token1Resp)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseUserErrorData.get(0).token1UserErr)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseErrorData.get(0).token1Err)}</td>
							<c:set var="sum1"
                         ...
                         tokenWiseErrorData.get(0).token1Err}" />
							<td>${IndexController.formatIndianCommaSeparated(sum1)}</td>
						</tr>
						<tr class="hovertr">
							<td class="labelAline">Token 2 (.7)</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseReqestData.get(0).token2Req)}</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseResponseData.get(0).token2Resp)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseUserErrorData.get(0).token2UserErr)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseErrorData.get(0).token2Err)}</td>
							<c:set var="sum2"
                         ...
                         tokenWiseErrorData.get(0).token2Err}" />
							<td>${IndexController.formatIndianCommaSeparated(sum2)}</td>
						</tr>
						<tr class="hovertr">
							<td class="labelAline">Token 3 (.8)</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseReqestData.get(0).token3Req)}</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseResponseData.get(0).token3Resp)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseUserErrorData.get(0).token3UserErr)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseErrorData.get(0).token3Err)}</td>
							<c:set var="sum3"
                         ...
                         tokenWiseErrorData.get(0).token3Err}" />
							<td>${IndexController.formatIndianCommaSeparated(sum3)}</td>
						</tr>
						<tr class="hovertr">
							<td class="labelAline">Token 4 (.9)</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseReqestData.get(0).token4Req)}</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseResponseData.get(0).token4Resp)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseUserErrorData.get(0).token4UserErr)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseErrorData.get(0).token4Err)}</td>
							<c:set var="sum4"
                         ...
                         tokenWiseErrorData.get(0).token4Err}" />
							<td>${IndexController.formatIndianCommaSeparated(sum4)}</td>
						</tr>
						<tr class="hovertr">
							<td class="labelAline">Token 5 (.34)</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseReqestData.get(0).token5Req)}</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseResponseData.get(0).token5Resp)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseUserErrorData.get(0).token5UserErr)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseErrorData.get(0).token5Err)}</td>
							<c:set var="sum5"
                         ...
                         tokenWiseErrorData.get(0).token5Err}" />
							<td>${IndexController.formatIndianCommaSeparated(sum5)}</td>
						</tr>
						<tr class="hovertr">
							<td class="labelAline">Token 6 (.35)</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseReqestData.get(0).token6Req)}</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseResponseData.get(0).token6Resp)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseUserErrorData.get(0).token6UserErr)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseErrorData.get(0).token6Err)}</td>
							<c:set var="sum6"
                         ...
                         tokenWiseErrorData.get(0).token6Err}" />
							<td>${IndexController.formatIndianCommaSeparated(sum6)}</td>
						</tr>
						<tr class="hovertr">
							<td class="labelAline">Token 7 (.36)</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseReqestData.get(0).token7Req)}</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseResponseData.get(0).token7Resp)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseUserErrorData.get(0).token7UserErr)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseErrorData.get(0).token7Err)}</td>
							<c:set var="sum7"
                         ...
                         tokenWiseErrorData.get(0).token7Err}" />
							<td>${IndexController.formatIndianCommaSeparated(sum7)}</td>
						</tr>
						<tr class="hovertr">
							<td class="labelAline">Token 8 (.37)</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseReqestData.get(0).token8Req)}</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(tokenWiseResponseData.get(0).token8Resp)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseUserErrorData.get(0).token8UserErr)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(tokenWiseErrorData.get(0).token8Err)}</td>
							<c:set var="sum8"
                         ...
                         tokenWiseErrorData.get(0).token8Err}" />
							<td>${IndexController.formatIndianCommaSeparated(sum8)}</td>
						</tr>
						<tr class="hovertr">
							<c:set var="ReqSum"
								value="${tokenWiseReqestData.get(0).token1Req + 
							...
							<th>Total</th>
							<td class="blueclolorwithweit">${IndexController.formatIndianCommaSeparated(ReqSum)}</td>
							<td class="blueclolorwithweit">${IndexController.formatIndianCommaSeparated(RespSum)}</td>
							<td class="blueclolorwithweit">${IndexController.formatIndianCommaSeparated(UserErrorSum)}</td>
							<td class="blueclolorwithweit">${IndexController.formatIndianCommaSeparated(AdvErrorSum)}</td>
			...
			<div class="columnleft1">
				<table id="myTable">
					<tr>
                        ...
                        <th rowspan="2">Res.<br>Pending</th>
        ...
        <td class="labelAline1" style="white-space: nowrap;">
            ...
            <span class="fontwet">(${aapdata.applicationCode})</span>
							...
							<td class="tokenizationcolor currency-inr">${aapdata.tokenRequest}</td>
							<td class="tokenizationcolor currency-inr">${aapdata.tokenTokensIssued}</td>
							<td class="tokenizationcolor">${IndexController.formatIndianCommaSeparated(aapdata.tokenAlreadyExi)}</td>
							<td class="detokenizationcolor">${IndexController.formatIndianCommaSeparated(aapdata.detokenRequest)}</td>
							<td class="detokenizationcolor">${IndexController.formatIndianCommaSeparated(aapdata.detokenResponse)}</td>
									<td class="jwtcolor">${IndexController.formatIndianCommaSeparated(aapdata.jwtRequest)}</td>
							<td class="jwtcolor">${IndexController.formatIndianCommaSeparated(aapdata.jwtResponse)}</td>
							<td>${IndexController.formatIndianCommaSeparated(aapdata.checkUID)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(aapdata.errorByUser)}</td>
							<td class="errorcolor">${IndexController.formatIndianCommaSeparated(aapdata.error)}</td>
                             <c:set var="checkStatus" value="${(aapdata.tokenRequest - aapdata.tokenTokensIssued - aapdata.tokenAlreadyExi) + (aapdata.detokenRequest - aapdata.detokenResponse) + (aapdata.jwtRequest - aapdata.detokenResponse) - aapdata.errorByUser - aapdata.error}" />
							<td class="verifydatacolor">${IndexController.formatIndianCommaSeparated(checkStatus)}</td>
							<td class="fontwet">${IndexController.formatIndianCommaSeparated(aapdata.totalRecords)}</td>
					...
					<tr>
						...
						<c:forEach var="aapdata" items="${appWiseData}">
							...
							<c:set var="totalRecords"
								...
								value="${((totalRequest + aapdata.tokenRequest)-(totalNewToken + aapdata.tokenTokensIssued)-(totalAlreadyEx + aapdata.tokenAlreadyExi))+((totalJwtRequest + aapdata.jwtRequest)-(totalJwtResponse + aapdata.jwtResponse))+((totalRetokenRequest + aapdata.detokenRequest)-(totalDetokenResponse + aapdata.detokenResponse))+(totalErrorByUser + aapdata.errorByUser)-(totalError + aapdata.error)}" />
                                                ...
                                                <td class="blueclolorwithweit">${IndexController.formatIndianCommaSeparated(totalRequest) }</td>
						...
						<c:choose>
							...
							<c:when
								test="${((TotalTXN-totalNewToken ) >= 100) && ((totalNewToken-TotalTXN) <= 100)}">
								<td class="blueclolorwithweit" style="color: red;">${IndexController.formatIndianCommaSeparated(totalNewToken)}</td>
							</c:when>
							<c:otherwise>
							<td class="blueclolorwithweit currency-inr">${totalNewToken}</td></c:otherwise>
						</c:choose>
						<%-- <td class="blueclolorwithweit">${IndexController.formatIndianCommaSeparated(totalNewToken) }</td> --%>
						<td class="blueclolorwithweit currency-inr">${totalAlreadyEx}</td>
						<td class="blueclolorwithweit currency-inr">${totalRetokenRequest}</td>
						<td class="blueclolorwithweit currency-inr">${totalDetokenResponse}</td>
						<td class="blueclolorwithweit currency-inr">${totalJwtRequest}</td>
						<td class="blueclolorwithweit currency-inr">${totalJwtResponse}</td>
						<td class="blueclolorwithweit currency-inr">${totalCheckUID}</td>
						<td class="blueclolorwithweit currency-inr">${totalErrorByUser}</td>
						<td class="blueclolorwithweit currency-inr">${totalError}</td>
                        <td class="blueclolorwithweit currency-inr">${totalcheckStatus}</td>
						<td class="blueclolorwithweit currency-inr">${totalRecords}</td>
					</tr>
				</table>
			</div>
