...
public interface TknSrvReqRepository15Min extends JpaRepository<TknSrvReq15Min, Long> {
	List<TknSrvReq15Min> findAllByDateContainingOrderByTokenIdDesc(String formattedDate);
